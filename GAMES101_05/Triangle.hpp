...
//判断光线求交 如果用1-u-v >=0 ，会出现蓝点 ，当你打印出来蓝点坐标时，会发现其正好为最大的负值浮点数，这是因为u，v正好在三角形交界与射线交点处。所以这里我更改了判断条件
                          ...
                          const Vector3f& dir, float& tnear, float& u, float& v)
{
    ...
    /*  Vector3f s0, s1,s2;
      ...
      float temp, t, b1, b2;
      temp = 1 / dotProduct(s1,e1);
      t = dotProduct(s2, e2) * temp;
      b1 = dotProduct(s1, s0) * temp;
      b2 = dotProduct(s2, dir) * temp;*/
